...
def objective(trial: optuna.Trial):
    ...
    # sense embeddings regularizaiton に関する条件付け
    dict_args["coef_sense_embeddings_regularizer"] = trial.suggest_loguniform("coef_sense_embeddings_regularizer", low=0.01, high=100.0)
    dict_args["sense_embeddings_regularizer_type"] = "cosine"
    ...
    cfg_gloss_projection_head["max_l2_norm_ratio"] = trial.suggest_discrete_uniform("max_l2_norm_ratio", low=0.01, high=0.03, q=0.001)
